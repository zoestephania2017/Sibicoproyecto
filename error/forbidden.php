...
try {
    ...
    $errorMessage = 'Acceso denegado, actualmente no tienes permisos para acceder a esta página/directorio.';
...
<head>
    ...
    <meta name="description" content="Pagina para mostrar el error 403 (Forbidden).">
    <link rel="manifest" href="<?= url('manifest.json') ?>">
    <link rel="shortcut icon" href="<?= url('src/img/icon_192x192.webp') ?>" type="image/x-icon">
    <title>Almacenes Copeco - Prohibido</title>
        ...
        <div class="container h-full">
            <div class="flex justify-center items-center w-full h-full">
                <div class="flex flex-col items-center">
                    ...
                    <h1 class="text-4xl font-bold text-center mt-4">Error 403</h1>
                    <h2 class="text-2xl font-bold text-center mt-4">Prohibido</h2>
                    <div class="mt-6">
