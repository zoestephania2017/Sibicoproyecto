...
<head>
    ...
    <meta name="description" content="Pagina para mostrar el error 404 (Not Found).">
    <link rel="manifest" href="<?= url('manifest.json') ?>">
    <link rel="shortcut icon" href="<?= url('src/img/icon_192x192.webp') ?>" type="image/x-icon">
    <title>Almacenes Copeco - Pagina no encontrada</title>
        ...
        <div class="container h-full">
            <div class="flex justify-center items-center w-full h-full">
                <div class="flex flex-col items-center">
                    ...
                    <h1 class="text-4xl font-bold text-center mt-4">Error 404</h1>
                    <h2 class="text-2xl font-bold text-center mt-4">Pagina no encontrada</h2>
                    <div class="mt-6">
