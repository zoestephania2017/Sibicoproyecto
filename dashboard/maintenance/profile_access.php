...
<head>
    ...
    <meta name="description" content="Administración de accesos, aquí podrás asignar los accesos a los perfiles.">
    <link rel="manifest" href="<?= url('manifest.json') ?>">
    <link rel="shortcut icon" href="<?= url('src/img/icon_192x192.webp') ?>" type="image/x-icon">
    <title>Almacenes Copeco - Asignar Acceso</title>
...
<body class="bg-gray-100">
    ...
    <main class="p-4 h-auto sm:ml-64">
        <div class="p-4 border-2 border-slate-300 border-dashed rounded-lg">
            <div class="flex flex-col gap-4 w-full">
                <div class="w-full h-auto bg-slate-300 rounded p-4 text-black shadow-lg">
                    <h1 class="text-4xl font-bold">Asignar Acceso</h1>
                </div>
                    ...
                    <div class="p-6 space-y-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label for="txtAccess" class="block mb-2 text-sm font-medium text-gray-900">Seleccione un acceso</label>
                                <select id="txtAccess" class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300">
