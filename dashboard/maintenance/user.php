...
if (!isset($protection) || !$protection->has("5")) {
    header('Location: ../?denied=true&_per=' . urlencode("5"), true, 302);
    exit;
}
?>
...
<head>
    ...
    <meta name="description" content="Administración de usuarios, aquí podrás gestionar los usuarios.">
...
<body class="bg-gray-100">
                    ...
                    <div class="p-6 space-y-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300" type="text" id="txtName">
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900" for="txtSurname">Apellido</label>
                                <input class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300" type="text" id="txtSurname">
                            </div>
                            <div class="col-span-2">
                                <label for="txtUser" class="block mb-2 text-sm font-medium text-gray-900">Usuario</label>
                                <input type="text" id="txtUser" class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300">
                            </div>
                            <div class="col-span-2">
                                <label for="txtAddress" class="block mb-2 text-sm font-medium text-gray-900">Dirección</label>
                                <textarea id="txtAddress" class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300" rows="3"></textarea>
                            </div>
                            <div>
                                <label for="txtLandlinePhone" class="block mb-2 text-sm font-medium text-gray-900">Teléfono fijo</label>
                                <input type="text" id="txtLandlinePhone" class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300">
                            </div>
                            <div>
                                <label for="txtMobilePhone" class="block mb-2 text-sm font-medium text-gray-900">Teléfono móvil</label>
                                <input type="text" id="txtMobilePhone" class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300">
                            </div>
                            <div class="col-span-2">
                                <label for="txtProfile" class="block mb-2 text-sm font-medium text-gray-900">Perfil</label>
                                <select class="block w-full px-4 py-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300" id="txtProfile">
    ...
    <script src="<?= url('src/js/maintenance/user/app-min.js') ?>" type="module" defer></script>
</body>
